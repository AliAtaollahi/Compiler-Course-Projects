...
public interface UTLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link UTLParser#globVariableDeclaration}.
	 * @param ctx the parse tree
	 */
	void enterGlobVariableDeclaration(UTLParser.GlobVariableDeclarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link UTLParser#globVariableDeclaration}.
	 * @param ctx the parse tree
	 */
	void exitGlobVariableDeclaration(UTLParser.GlobVariableDeclarationContext ctx);
}